...
public class CalendarUtil {
    ...
    private static CalendarUtil sUtils;
    private Map<String, int[]> sAllHolidays = new HashMap<>();
    private Map<String, List<Integer>> sMonthTaskHint = new HashMap<>();

    public static synchronized CalendarUtil getInstance(Context context) {
        if (sUtils == null) {
            sUtils = new CalendarUtil();
     ...
     * */
    public static int getWeekNum(String dateString , String format){
